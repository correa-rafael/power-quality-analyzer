...
public class GraficoPfActivity extends AppCompatActivity {
    ...
    private ValueEventListener valueEventListenerTempoRealPF;
    private ValueEventListener valueEventListenerHistoricoPF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafico_p_f);
    ...
    private void inserirDataHistorico() {
        ...
        valueEventListenerHistoricoPF = chartRef2.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ArrayList<Entry> dataVals2 = new ArrayList<>();
                if (snapshot.hasChildren()) {
                    ...
                    for (DataSnapshot dados : snapshot.getChildren()) {
                        ...
                        String horario = medida.getHorario();
                        double newHorario = formatarHorario(horario);
                        dataVals2.add(new Entry((float) newHorario, (float) PF));
    ...
    protected void onStop() {
        ...
        chartRef.removeEventListener(valueEventListenerTempoRealPF);
        chartRef2.removeEventListener(valueEventListenerHistoricoPF);
    }
}
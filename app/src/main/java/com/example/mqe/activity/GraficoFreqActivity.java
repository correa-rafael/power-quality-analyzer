...
public class GraficoFreqActivity extends AppCompatActivity {
    ...
    private ValueEventListener valueEventListenerTempoRealFreq;
    private ValueEventListener valueEventListenerHistoricoFreq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafico_freq);
    ...
    private void inserirDataHistorico() {
        ...
        valueEventListenerHistoricoFreq = chartRef2.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ArrayList<Entry> dataVals2 = new ArrayList<>();
                if (snapshot.hasChildren()) {
                    ...
                    for (DataSnapshot dados : snapshot.getChildren()) {
                        ...
                        String horario = medida.getHorario();
                        double newHorario = formatarHorario(horario);
                        dataVals2.add(new Entry((float) newHorario, (float) freq));
    ...
    protected void onStop() {
        ...
        chartRef.removeEventListener(valueEventListenerTempoRealFreq);
        chartRef2.removeEventListener(valueEventListenerHistoricoFreq);
    }
}
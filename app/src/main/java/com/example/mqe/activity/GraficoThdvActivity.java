...
public class GraficoThdvActivity extends AppCompatActivity {
    ...
    private ValueEventListener valueEventListenerTempoRealThdv;
    private ValueEventListener valueEventListenerHistoricoThdv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafico_thdv);
    ...
    private void inserirDataHistorico() {
        ...
        valueEventListenerHistoricoThdv = chartRef2.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ArrayList<Entry> dataVals2 = new ArrayList<>();
                if (snapshot.hasChildren()) {
                    ...
                    for (DataSnapshot dados : snapshot.getChildren()) {
                        ...
                        String horario = medida.getHorario();
                        double newHorario = formatarHorario(horario);
                        dataVals2.add(new Entry((float) newHorario, (float) thdv));
    ...
    protected void onStop() {
        ...
        chartRef.removeEventListener(valueEventListenerTempoRealThdv);
        chartRef2.removeEventListener(valueEventListenerHistoricoThdv);
    }
}